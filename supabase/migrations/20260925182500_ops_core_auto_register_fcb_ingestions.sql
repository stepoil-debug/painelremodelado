-- Keep automatic FCB registration consistent for both ingestion-backed PDFs
-- and Drawing rows that are explicitly flagged as FCB.
...
begin
  ...
  return jsonb_build_object(
    'ok',true,
    'fcb_projects',v_detected,
    'auto_registered',v_registered,
    'pending_information',v_pending,
    'awaiting_fcb',v_waiting,
    'refreshed_at',now()
  );
end;
$$;
